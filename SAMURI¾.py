...
╠❂➣『บุก-เข้ามา-กุ๊กๆๆ-โม่ๆๆ』= สั่งร่างคิกเกอร์เข้า
╠❂➣『ออก』= สั่งร่างคิกเกอร์ออก
╠❂➣『Tl: text』= สร้างชื่อใวรัส
╠❂➣『เปิดเข้า/ปิดเข้า』= เข้า/ไม่ กลุ่มเอง
╠❂➣『เปิดแอด/ปิดแอด』= รับ/ไม่ เพื่อนเอง
╠❂➣『เปิดออก/ปิดออก』=  เข้า/ไม่ แชทรวม
...
╠❂➣『แทค』= แทคทั้งห้อง
╠❂➣『Love』ลงไวรัส แอนดรอยจะค้าง เด้งออก‼️‼️‼
╠❂➣『ลบรัน』= ลบห้องรัน
╠══════════════════
║─┅═✥🌿คำสั่งในกลุ่ม🌿✥═┅─
╠══════════════════ 
...
╠❂➣『Wikipedia』
╠❂➣『Cleanse』
╠❂➣『Bs』= เชคความไวคิกเกอร์
╠❂➣『Bot1-Bot2 link on/off』
╠❂➣『Key』
╠❂➣『เปิดเตือน/ปิดเตือน』
╠❂➣『เปิดลิ้ง/ปิดลิ้ง』
╠❂➣『Backup on/off』
...
║✰ Nuke ➠สั่งคิกเกอร์บินห้อง
╠══════════════════════
║ By: •─✯͜͡ ✯RED★SAMURI★SELFBOT✯͜͡ ✯─•
╠══════════════════════
"""
KAC=[cl,ki1,ki2]
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me By:─┅═✥ 🇹🇭RED SAMURI BOT🇹🇭 ✥═┅─",
    "lang":"JP",
    "comment":"AutoLike by ─┅═✥ 🇹🇭RED SAMURI BOT🇹🇭 ✥═┅─",
    "commentOn":False,
    "acommentOn":False,
    "bcommentOn":False,
    "ccommentOn":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = [""]
                     ret_ = "แซวอัตโนมัติ\n💙แทคสะกิดจัง💙\n🔞ชอบก็โทรมา🔞" + random.choice(balas)
...
#----------------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        ...
                        pass
            elif msg.text.lower() in ["แอดมิน","@bot"]:
                msg.contentType = 13
                adm = 'u5dfdb871f83b248c0d8d00d74815c252'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line https://line.me/ti/p/bigboss337")
            ...
            elif msg.text in ["Bot1 invite","bot1 Invite"]:
                wait["ainvite"] = True
                ki1.sendText(msg.to,"Send Contact")
            elif msg.text in ["Bot2 invite","bot2 Invite"]:
                wait["binvite"] = True
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki1.updateProfile(profile)
            ...
            elif msg.text in ["เข้ามา","Masuk","Join all","Kicker","kicker","กุ๊กๆๆ","โม่ๆๆ"]:
                        ...
                        ki1.sendText(msg.to,"สวัสดีคับแอด 🙏" + str(ginfo.name))
                        ki2.sendText(msg.to,"สวัสดีคับเพื่อนๆทุกคน ✋" )
                        cl.sendText(msg.to,"ฝากเนื้อฝากตัวด้วยนะ💋💋 " )
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki1.updateGroup(G)
...
#==================================================
				...
				msg.contentMetadata = {'mid': mid}
				cl.sendMessage(msg)
				cl.sendText(msg.to,"[SELFBOT TUM HACK BOT]")
            elif "ไอดี" == msg.text:
                key = msg.to
...
#เทส
            ...
            elif msg.text in ["Protect:on","Protect on","เปิดกัน"]:
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
                ...
                if wait["qr"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already on")
            elif msg.text in ["Protect:off","Protect off","ปิดกัน"]:
            ...
            elif msg.text in ["เปิดเข้า","Join on","Join:on","Auto join:on","Poin on"]:
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah on Bosqu")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Ok Bosqu")
            elif msg.text in ["ปิดเข้า","Auto join off","Auto join:off","Join:off","Poin off"]:
            ...
            elif msg.text in ["Leave:on","Auto leave on","Auto leave:on","Leave on","เปิดออก"]:
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    else:
            ...
            elif msg.text in ["Leave:off","Auto leave off","Auto leave:off","Leave off","ปิดออก"]:
            ...
            elif msg.text in ["共有:オン","Share on","Share:on","เปิดแชร์"]:
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    else:
...
#------------------------------------------------
            elif msg.text in ["Gcreator:inv","เชิญเเอด"]:
	           if msg.from_ in admin:
                    ginfo = cl.getGroup(msg.to)
                    ...
                    try:
                       ...
                       pass
#-----------------------------------------------
            elif msg.text in ["Backup:on","Backup on","ดึงกลับ"]:
                if wait["Backup"] == True:
                    if wait["lang"] == "JP":
                ...
                if wait["autoAdd"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Sudah on Bosqu")
            elif msg.text in ["Add:off","ปิดแอด","Auto add:off","Add off"]:
...
#========================================
                ...
                if msg.toType == 2:
                    ...
                    if x.preventJoinByTicket == True:
                        x.preventJoinByTicket = False
                        k2.updateGroup(x)
                    gurl = k2.reissueGroupTicket(gid)
                    k2.sendText(msg.to,"line://ti/g/" + gurl)
                else:
                    k2.sendText(msg.to,"Not for use less than group")
#========================================
...
#========================================
            elif "สอดแนม3 @" in msg.text:            
                print "[Command]dp executing"
                _name = msg.text.replace("สอดแนม3 @","")
                _nametarget = _name.rstrip('  ')
                gs = cl.getGroup(msg.to)
                targets = []
                for g in gs.members:
            ...
            elif "สอดแนม2mid:" in msg.text:
                umid = msg.text.replace("สอดแนม2mid:","")
                ...
                try:
                    ...
                    cl.sendText(msg.to,(error))
                    pass
            elif "สอดแนม2 " in msg.text:
                if msg.toType == 2:
                    msg.contentType = 0
                    steal0 = msg.text.replace("สอดแนม2 ","")
...
#===============================================
                ...
                cl.sendText(msg.to, "ประมวลผลความเร็ว/เทียบค่าต่อวินาที...")
                start = time.time()
                time.sleep(0.001)
                ...
                ki.sendText(msg.to, "[RED SAMURI SELFBOT]\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off")
...
#========================================
                ...
                try:
                    ...
                    cl.sendText(msg.to, "คืนสู่ร่างเดิมแล้ว")
                except Exception as e:
                    cl.sendText(msg.to, str (e))
...
#-----------------------------------------------
            ...
            elif msg.text in ["Notifed on","เปิดเตือน","M on"]:
              if msg.from_ in admin:
                if wait["Notifed"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Done\n\nเปิดเเจ้งเเตือนของคุณเเล้ว")
            elif msg.text in ["Notifed off","ปิดเตือน","M off"]:
              if msg.from_ in admin:
...
#-----------------------------------------------
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                        ...
                        pass
#-------------------------------------------------
            elif msg.text in ["เปิดหมด","Red on"]:
                        cl.sendText(msg.to,"RED SAMURI BOT")
                        cl.sendText(msg.to,"Please wait......")
            ...
            elif msg.text in ["ปิดหมด","Red off"]:
                        cl.sendText(msg.to,"RED SAMURI BOT")
                        cl.sendText(msg.to,"Please wait......")
					...
					for target in targets:
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                        	    ...
                        	    cl.updateGroup(gs)
#-----------------------------------------------------------
            elif "ontagjoin:" in msg.text:
                try:
                    source_str = 'abcdefghijklmnopqrstuvwxyz1234567890@:;./_][!&%$#)(=~^|'
                    name = "".join([random.choice(source_str) for x in xrange(10)])
                    amid = msg.text.replace("contagjoin:","")
...
#==============================================================================#
            ...
            elif "Getgid:" in msg.text:
                saya = msg.text.replace("Grtgid:","")
                gid = cl.getGroupIdsJoined()
                for i in gid:
                    h = cl.getGroup(i).id
                    group = cl.getGroup(i)
            ...
            elif msg.text in ["Friendlist","เช็คเพื่อน","เพื่อน","Fyall"]:    
            ...
            elif msg.text in ["tag","Tag","แทก","แทค"]:
                 group = cl.getGroup(msg.to)
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    raise e
            elif "ล้วงข้อมูล" in msg.text:
                       nk0 = msg.text.replace("ล้วงข้อมูล","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("","")
                       nk3 = nk2.rstrip()
                       _name = nk3
